...
import { X, Calendar, Flag, Image as ImageIcon, Loader2 } from 'lucide-react';
...
export function CreateTaskModal({ isOpen, onClose, onSubmit, columnTitle }: CreateTaskModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="flex items-center justify-between p-6 border-b border-slate-200 dark:border-slate-800">
                    <div>
                        <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Create New Task</h2>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">in {columnTitle}</p>
                    </div>
                    <button
                        onClick={onClose}
